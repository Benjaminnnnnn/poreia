...
import { ActivityDragOverlayCard, SortableActivityItem } from "@/entities/activity/ui/ActivityItem";
import { COLORS, DAY_MARKER_COLORS } from "@/entities/itinerary/config/workspaceConfig";
