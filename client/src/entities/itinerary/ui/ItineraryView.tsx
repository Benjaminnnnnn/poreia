...
import {
  ...
  ItinerarySectionNav,
  ItinerarySidePanel,
} from "@/entities/itinerary/ui/ItineraryLayout";
import { PlaceDetailOverlay } from "@/entities/itinerary/ui/PlaceDetailCard";
import {
  DAY_CONTAINER_PATTERN,
  DAY_MARKER_COLORS,
  WorkspaceTab,
} from "@/entities/itinerary/config/workspaceConfig";
import { PageLoading } from "@/shared/ui/PageLoading";

const ItineraryPlanView = lazy(() => import("@/entities/itinerary/ui/ItineraryPlanView"));
const WorldMap = dynamic(() => import("@/entities/trip/ui/TripMap"), { ssr: false });
